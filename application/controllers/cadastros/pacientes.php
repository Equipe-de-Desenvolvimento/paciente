...
//        $data['arquivo_pasta'] = directory_map(base_url()."upload/$paciente_id/");
        $data['arquivo_pasta'] = directory_map(base_url()."upload/paciente/$paciente_id/");
...
//        die;
        ...
        $config['upload_path'] = base_url()."upload/paciente/" . $paciente_id . "/";
//        $config['upload_path'] = base_url()."upload/paciente/" . $paciente_id . "/";

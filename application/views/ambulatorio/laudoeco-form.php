                                ...
                                <fieldset>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td width="60px;"><font size = -1><input type="text" name="Superf" id="Superf" class="texto02" value="<?= @$obj->_superficie_corporea; ?>" readonly/></font></td>
                                        ...
                                        <tr>
                                            <td colspan="5"><font size = -1>VENTRÍCULO ESQUERDO</font></td>
                                            <td width="60px;"></td>
                                            <td ></td>
                                            <td colspan="2"><font size = -1>Valor normal</font></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5"><font size = -1>Volume telediastólico</font></td>
                                            <td width="60px;"><font size = -1><input type="text" name="Volume_telediastolico" id="Volume_telediastolico" onkeyup="multiplica()"  class="texto02" value="<?= @$obj->_ve_volume_telediastolico; ?>" readonly/></font></td>
                                            <td ><font size = -1>ml</font></td>
                                            <td ><font size = -1>50-176</font></td>
                                            <td ><font size = -1>ml</font></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5"><font size = -1>Volume telessistólico</font></td>
                                            <td width="60px;"><font size = -1><input type="text" name="Volume_telessistolico" id="Volume_telessistolico" class="texto02" value="<?= @$obj->_ve_volume_telessistolico; ?>" readonly/></font></td>
                                            <td ><font size = -1>ml</font></td>
                                            <td ><font size = -1>12-47</font></td>
                                            <td ><font size = -1>ml</font></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5"><font size = -1>Diâmetro telediastólico </font></td>
                                            <td width="60px;"><input type="text" name="Diametro_telediastolico" id="Diametro_telediastolico"  class="texto02" value="<?= @$obj->_ve_diametro_telediastolico; ?>" /></font></td>
                                            <td ><font size = -1>mm</font></td>
                                            <td ><font size = -1>42-56 </font></td>
                                            <td ><font size = -1>mm</font></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5"><font size = -1>Diâmetro telessistólico</font> </td>
                                            <td width="60px;"><input type="text" name="Diametro_telessistolico" id="Diametro_telessistolico" class="texto02" value="<?= @$obj->_ve_diametro_telessistolico; ?>"/></font></td>
                                            <td ><font size = -1>mm</font></td>
                                            <td ><font size = -1>23-36 </td>
                                            <td ><font size = -1>mm</font></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5"><font size = -1>Índice do diâmetro diastólico </font></td>
                                            <td width="60px;"><font size = -1><input type="text" name="indice_diametro_diastolico" id="indice_diametro_diastolico" class="texto02" value="<?= @$obj->_ve_indice_do_diametro_diastolico; ?>"readonly/></font></td>
                                            <td ><font size = -1>mm/m²</font></td>
                                            <td ><font size = -1>22-31</font></td>
                                            <td ><font size = -1>mm/m²</font></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5"><font size = -1>Septo interventricular </font></td>
                                        ...
                                        <tr>
                                            <td colspan="5"><font size = -1>Parede posterior </font></td>
                                            <td width="60px;"><font size = -1><input type="text" name="Parede_posterior" id="Parede_posterior" class="texto02" value="<?= @$obj->_ve_parede_posterior; ?>"/></font></td>
                                            <td ><font size = -1>mm</font></td>
                                            <td ><font size = -1>6-10</font></td>
                                            <td ><font size = -1>mm</font></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5"><font size = -1>Relação septo/parede posterior</font> </td>
                                            <td width="60px;"><font size = -1><input type="text" name="Relacao_septo_parede" id="Relacao_septo_parede" class="texto02" value="<?= @$obj->_ve_relacao_septo_parede_posterior; ?>" readonly/></font></td>
                                            <td ></td>
                                        ...
                                        <tr>
                                            <td colspan="5"><font size = -1>Massa ventricular </font></td>
                                            ...
                                            <td ><font size = -1>< 166  </font></td>
                                            <td ><font size = -1>g</font></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5"><font size = -1>Índice de massa</font> </td>
                                            <td width="60px;"><font size = -1><input type="text" name="indice_massa" id="indice_massa" class="texto02" value="<?= @$obj->_ve_indice_massa; ?>" readonly/></font></td>
                                            <td ><font size = -1>g/m²</font></td>
                                            <td ><font size = -1>< 116 </font> </td>
                                            <td ><font size = -1>g/m²</font></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5"><font size = -1>Relação volume/massa</font> </td>
                                            <td width="60px;"><font size = -1><input type="text" name="Relacao_volume_massa" id="Relacao_volume_massa" class="texto02" value="<?= @$obj->_ve_relacao_volume_massa; ?>" readonly/></font></td>
                                            <td ></td>
                                            <td ></td>
                                            <td ></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td colspan="9"><font size = -1>&nbsp;</font></td>

                                        </tr>
                                        <tr>
                                            <td colspan="5"><font size = -1>VENTRÍCULO DIREITO</font></font></td>
                                            <td width="60px;"></td>
                                            <td ></td>
                                            <td colspan="2"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5"><font size = -1>Diâmetro telediastólico</font></td>
                                            <td width="60px;"><font size = -1><input type="text" name="Diametro_telediastolico" id="Diametro_telediastolico" class="texto02" value="<?= @$obj->_vd_diametro_telediastolico; ?>"/></font></td>
                                            <td ><font size = -1>mm</font></font></td>
                                            <td ><font size = -1>< 34 </font></td>
                                            <td <font size = -1>>mm</font></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5"><font size = -1>Área telediastólica</font></td>
                                            <td width="60px;"><font size = -1><input type="text" name="area_telediastolica" id="area_telediastolica" class="texto02" value="<?= @$obj->_vd_area_telediastolica; ?>"/></font></td>
                                        ...
                                        <tr>
                                            <td colspan="5"><font size = -1>ÁTRIO ESQUERDO</font></td>
                                            <td width="60px;"></td>
                                            <td ></td>
                                            <td colspan="2"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5"><font size = -1>Diâmetro </font></td>
                                            <td width="60px;"><font size = -1><input type="text" name="Diametro" id="Diametro" class="texto02" value="<?= @$obj->_ae_diametro; ?>"/></font></td>
                                            <td ><font size = -1>mm</font></td>
                                            <td ><font size = -1>30-40  </font></font></td>
                                            <td ><font size = -1>mm</font></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5"><font size = -1>Índice de diâmetro</font> </td>
                                            <td width="60px;"><font size = -1><input type="text" name="indice_diametro" id="indice_diametro" class="texto02" value="<?= @$obj->_ae_indice_diametro; ?>"/></font></td>
                                            <td ><font size = -1>mm/m²</font></td>
                                            <td ><font size = -1>15-23</font> </td>
                                            <td ><font size = -1>mm/m²</font></td>
                                        </tr>
                                        <tr>
                                            <td colspan="9"><font size = -1>&nbsp;</font></td>
                                        ...
                                        <tr>
                                            <td colspan="5"><font size = -1>Diâmetro da raiz </font></td>
                                            <td width="60px;"><font size = -1><input type="text" name="Diametro_raiz" id="Diametro_raiz" class="texto02" onblur="history.go(0)" value="<?= @$obj->_ao_diametro_raiz; ?>"/></font></td>
                                            <td ><font size = -1>mm</font></td>
                                            <td ><font size = -1>20-37</font></td>
                                            <td ><font size = -1>mm</font></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5"><font size = -1>Relação átrio esquerdo/aorta </font></td>
                                            <td width="60px;"><font size = -1><input type="text" name="Relacao_atrio_esquerdo" id="Relacao_atrio_esquerdo" class="texto02" value="<?= @$obj->_ao_relacao_atrio_esquerdo_aorta; ?>" readonly/></font></td>
                                            <td ></td>
                            ...
                            <script type="text/javascript">
                                ...
                                $(document).ready(function() {
                                    ...
                                    function multiplica()
                                    {
                                        ...
                                        diametro_telessistolicof7 = new Number(document.getElementById('Diametro_telessistolico').value);
                                        diametro_telediastolicof6 = new Number(document.getElementById('Diametro_telediastolico').value);
                                        septo_interventricularf9 = new Number(document.getElementById('Septo_interventricular').value);
                                        parede_posteriorf10 = new Number(document.getElementById('Parede_posterior').value);
                                        diametrof24 = new Number(document.getElementById('Diametro').value);
                                        diametro_raizf30 = new Number(document.getElementById('Diametro_raiz').value);
                                        volume_telediastolicof4 = Math.pow(diametro_telediastolicof6,3)/1000;
                                        volume_telessistolicof5 = Math.pow(diametro_telessistolicof7,3)/1000;
                                        indice_diametro_diastolicof8 = diametro_telediastolicof6 / superfh1;
                                        relacao_septo_paredef11 = septo_interventricularf9 / parede_posteriorf10;
                                        espessura_relativaf12 = (septo_interventricularf9 + parede_posteriorf10) / diametro_telediastolicof6;
                                        resultadosoma = (diametro_telediastolicof6 + (2 * parede_posteriorf10));
                                        massa_ventricularf13 = (0.8*(1.04*((Math.pow(resultadosoma,3)/1000)- volume_telediastolicof4)))+0.6;
                                        indice_massaf14 = massa_ventricularf13 / superfh1;
                                        relacao_volume_massaf15 = Math.pow(diametro_telediastolicof6,3)/1000 / massa_ventricularf13;
                                        fracao_ejecaof16 = (volume_telediastolicof4*7/((diametro_telediastolicof6/10)+2.4)-volume_telessistolicof5*7/((diametro_telessistolicof7/10)+2.4))/(volume_telediastolicof4*7/((diametro_telediastolicof6/10)+2.4))*100;
                                        fracao_encurtamentof17 = (diametro_telediastolicof6 - diametro_telessistolicof7)/(diametro_telediastolicof6)*100;
                                        relacao_atrio_esquerdof33 = diametrof24 / diametro_raizf30;
                                        document.getElementById('Volume_telediastolico').value = volume_telediastolicof4.toFixed(2);
                                        document.getElementById('Volume_telessistolico').value = volume_telessistolicof5.toFixed(2);
                                        document.getElementById('Superf').value = superfh1.toFixed(2);
                                        document.getElementById('indice_diametro_diastolico').value = indice_diametro_diastolicof8.toFixed(2);
                                        document.getElementById('Relacao_septo_parede').value = relacao_septo_paredef11.toFixed(2);
                                        document.getElementById('Espessura_relativa').value = espessura_relativaf12.toFixed(2);
                                        document.getElementById('Massa_ventricular').value = massa_ventricularf13.toFixed(2);
                                        document.getElementById('indice_massa').value = indice_massaf14.toFixed(2);
                                        document.getElementById('Relacao_volume_massa').value = relacao_volume_massaf15.toFixed(2);
                                        document.getElementById('Fracao_ejecao').value = fracao_ejecaof16.toFixed(2);
                                        document.getElementById('Fracao_encurtamento').value = fracao_encurtamentof17.toFixed(2);
                                        document.getElementById('Relacao_atrio_esquerdo').value = relacao_atrio_esquerdof33.toFixed(2);
                                    }
                                    multiplica();

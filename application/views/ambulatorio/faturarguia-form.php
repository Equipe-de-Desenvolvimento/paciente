            ...
            <form name="form_faturar" id="form_faturar" action="<?= base_url() ?>ambulatorio/guia/gravarfaturadoguia" method="post">
                <fieldset>
                    ...
                    <dl class="dl_desconto_lista">
                        ...
                        <dd>
                            <input type="text" name="dinheiro" id="dinheiro" value="0" onblur="history.go(0)"  class="texto01"/>
                            <select  name="juroscartao" id="juroscartao" class="size1" onblur="history.go(0)">
                        ...
                        <dd>
                            <input type="text" name="totalpagar" id="totalpagar"  class="texto01" onblur="history.go(0)"/>
                        </dd>
                        <dt>
